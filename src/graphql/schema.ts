...
export type GetHeroImagesQueryVariables = Exact<{ [key: string]: never }>;

export type GetHeroImagesQuery = { __typename?: 'Query' } & {
	heroCollection?: Maybe<
		{ __typename?: 'HeroCollection' } & {
			items: Array<
				Maybe<
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		...
		getHeroImages(
			variables?: GetHeroImagesQueryVariables,
			requestHeaders?: Dom.RequestInit['headers']
		): Promise<GetHeroImagesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetHeroImagesQuery>(GetHeroImagesDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getHeroImages'
